 ...
 * 
 */
package com.vinodborole.portal.common;

/**
 * Model classes decorated with this interface are compatible for write/update
 * operations and can be created via the Builder API.
 * 
 * @author vinodborole
 *
 */
